...
with aba_cadastro:
    ...
    if ui.button("Finalizar e Salvar Consulta", type="primary"):
        if nome == "" or peso == 0.0 or altura == 0.0:
            ...
            # 2. Cálculo da Recomendação de Água (35ml por kg)
            agua_ideal = (peso * 35) / 1000

            # 3. Gasto Calórico Diário (Fórmula de Harris-Benedict)
            ...
            # 4. Ajuste de Calorias e Cálculo de Macronutrientes por Objetivo
            ...
            # Cálculo dos Carboidratos: O que sobrar das calorias vai para o carbo
            ...
            g_carboidratos = max(0.0, calorias_restantes / 4) # Evita números negativos por segurança
            ...
            # Exibição dos Macronutrientes em colunas bonitas
            ...
            # Gravando os dados no CSV (Adicionando os macros na planilha)
